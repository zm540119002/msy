<?php /*a:5:{s:78:"/home/www/web/thinkphp5.1/mch/application/index/view/message_center/index.html";i:1551064593;s:18:"template/base.html";i:1551077175;s:26:"template/login_dialog.html";i:1551077175;s:23:"template/login_tpl.html";i:1551077175;s:33:"template/forget_password_tpl.html";i:1551077175;}*/ ?>
<!DOCTYPE html>
...
<article class="f24 ">
    <section class="header_title separation-line">
		...
		<h2 class="f24">消息中心</h2>
	</section>
	<section class="">
		<ul class="message_list">
			<li class="no_data">
				<img src="http://mch.meishangyun.com/static/common/img/no-news.png" alt="">
			</li>
			<div style="display:none;">
			<li>
				<img src="http://mch.meishangyun.com/static/common/img/logistics.png" alt="" class="left logistics">
				<div class="msg_r">
					<p class="columns_flex l-r-sides">
						<span>物流消息</span>
						<span>2019-1-5</span>
					</p>
					<p>已签收，您在南极星家居专营店购买的商品...</p>
				</div>
			</li>
			<li>
				<img src="http://mch.meishangyun.com/static/common/img/notice.png" alt="" class="left">
				<div class="msg_r">
					<p class="columns_flex l-r-sides">
						<span>通知消息</span>
						<span>2019-1-5</span>
			...
			<li>
				<img src="http://mch.meishangyun.com/static/common/img/interaction.png" alt="" class="left">
				<div class="msg_r">
					<p class="columns_flex l-r-sides">
						<span>互动消息</span>
						<span>2019-1-5</span>
