<?php /*a:5:{s:69:"/home/www/web/thinkphp5.1/mch/application/index/view/index/index.html";i:1551340852;s:18:"template/base.html";i:1551077175;s:26:"template/login_dialog.html";i:1551077175;s:23:"template/login_tpl.html";i:1551077175;s:33:"template/forget_password_tpl.html";i:1551077175;}*/ ?>
<!DOCTYPE html>
		...
		<div class="swiper-container swiper-container-horizontal swiper-container-ios">
			<div class="swiper-wrapper">
				<div class="swiper-slide swiper-slide-active">
					<img src="http://mch.meishangyun.com/static/common/img/banner/mch_banner.jpg" alt="" class="common_default_img">
				</div>
		...
		<div class="content-padding">
			<div>
				<div class="scroll_news">
					<a class="news_tit">
						美创会头条
						<!--<img src="http://mch.meishangyun.com/static/common/img/wy_logo.png" alt="">-->
					</a>
			...
			<section class="slider_banner">
				<div class="swiper-container swiper-container-horizontal swiper-container-ios">
					<div class="swiper-wrapper">
						<div class="swiper-slide swiper-slide-active">
							<a href="">
								<img src="http://mch.meishangyun.com/static/common/img/banner/xianshi.jpg" alt="" class="common_default_img">
							</a>
						</div>
						<div class="swiper-slide ">
							<a href="">
			...
			<div class="scene_wrapper">
				...
				<div class="graphic_item graphic_item_65 img<?php echo htmlentities($key); ?>" >
					<a href="<?php echo url('Scene/detail',['id'=>$info['id']]); ?>"  data-id="<?php echo htmlentities($info['id']); ?>">
						<div class="show-img">
							...
							<img src="http://mch.meishangyun.com/static/common/img/default/no_pic_100.jpg" alt="">
							<?php else: ?>
							<img src="http://mch.meishangyun.com/uploads/<?php echo htmlentities($info['thumb_img']); ?>" alt="">
							<?php endif; ?>
						</div>
					</a>
				</div>
				...
				<div class="columns_flex l-r-sides">
					<a href="<?php echo url('Scene/jiameng'); ?>" class="graphic_item">
						<img src="http://mch.meishangyun.com/static/common/img/jiameng.jpg" alt="">
					</a>
					<a href="" class="graphic_item">
						<img src="http://mch.meishangyun.com/static/common/img/yiqi.jpg" alt="">
					</a>	
					<a href="" class="graphic_item">
						<img src="http://mch.meishangyun.com/static/common/img/kaidian.jpg" alt="">
					</a>
				</div>
				<div class="columns_flex l-r-sides">
					<a href="" class="graphic_item">
						<img src="http://mch.meishangyun.com/static/common/img/qs.jpg" alt="">
					</a>	
					<a href="" class="graphic_item">
						<img src="http://mch.meishangyun.com/static/common/img/lk.jpg" alt="">
					</a>
				</div>
				<div class="columns_flex l-r-sides">
					<a href="" class="graphic_item">
						<img src="http://mch.meishangyun.com/static/common/img/sk.jpg" alt="">
					</a>	
					<a href="" class="graphic_item">
						<img src="http://mch.meishangyun.com/static/common/img/hl.jpg" alt="">
					</a>
				</div>
				<div class="columns_flex l-r-sides">
					<a href="" class="graphic_item">
						<img src="http://mch.meishangyun.com/static/common/img/xly.jpg" alt="">
					</a>	
					<a href="" class="graphic_item">
						<img src="http://mch.meishangyun.com/static/common/img/xlr.jpg" alt="">
					</a>
				</div>
				<div class="columns_flex l-r-sides">
					<a href="" class="graphic_item">
						<img src="http://mch.meishangyun.com/static/common/img/jujia.jpg" alt="">
					</a>	
					<a href="" class="graphic_item">
						<img src="http://mch.meishangyun.com/static/common/img/wz.jpg" alt="">
					</a>
				</div>
			</div>
