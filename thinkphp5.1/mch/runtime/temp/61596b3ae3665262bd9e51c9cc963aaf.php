<?php /*a:1:{s:65:"D:\web\thinkphp5.1\mch\application/index/view\order\list_tpl.html";i:1551065534;}*/ ?>
            ...
            <a href="<?php echo url('order/detail',['order_sn'=>$info['sn']]); ?>">
                ...
                <div class="order_item" data-id="<?php echo htmlentities($goods_info['goods_id']); ?>" data-buy_type="<?php echo htmlentities($goods_info['buy_type']); ?>"
                     data-brand_id="<?php echo htmlentities($goods_info['brand_id']); ?>"  data-brand_name="<?php echo htmlentities($goods_info['brand_name']); ?>"  >
                        ...
                        <img src="http://mch.new.com/static/common/img/default/no_pic_100.jpg" class="left">
                        <?php else: ?>
                        <img src="http://mch.new.com/uploads/<?php echo htmlentities($goods_info['thumb_img']); ?>" class="left">
                        <?php endif; ?>
...
<li class="no_data">
    <img src="http://mch.new.com/static/common/img/no-order.png" alt="">
</li>
<?php endif; endif; ?>