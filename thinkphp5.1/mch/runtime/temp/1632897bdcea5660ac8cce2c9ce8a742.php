<?php /*a:6:{s:68:"/home/www/web/thinkphp5.1/mch/application/index/view/mine/index.html";i:1551259789;s:18:"template/base.html";i:1551077175;s:31:"template/wallet_pay_dialog.html";i:1551077175;s:26:"template/login_dialog.html";i:1551077175;s:23:"template/login_tpl.html";i:1551077175;s:33:"template/forget_password_tpl.html";i:1551077175;}*/ ?>
<!DOCTYPE html>
    ...
    <section class="separation-line columns_flex l-r-sides flex_item">
        ...
        <div class="user_top">
            <a href="javascript:void(0);" id="login_dialog">
               <img src="http://mch.meishangyun.com/static/common/img/default/head_50.png" alt="">
               注册登录
           </a>
        </div>
        <?php else: ?>
        <div class="user_top_item user_info_list">
            ...
            <img src="http://mch.meishangyun.com/static/common/img/default/chat_head.jpg" class="left user_header">
            <?php else: ?>
            <img src="http://mch.meishangyun.com/uploads/<?php echo htmlentities($user['avatar']); ?>" class="left user_header">
            <?php endif; ?>
        ...
        <a href="javascript:void(0);" class="customer_info">
            <img src="http://mch.meishangyun.com/static/common/img/modify.png" alt="">
        </a>
        <?php endif; ?>
...
<script type="text/javascript" src="http://mch.meishangyun.com/static/common/js/wallet.js"></script>
