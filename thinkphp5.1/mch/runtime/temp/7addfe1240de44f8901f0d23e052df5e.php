<?php /*a:8:{s:64:"D:\web\thinkphp5.1\mch\application/index/view\scene\jiameng.html";i:1551256874;s:18:"template/base.html";i:1551083825;s:66:"D:\web\thinkphp5.1\mch\application/index/view\brand\set_brand.html";i:1551065534;s:70:"D:\web\thinkphp5.1\mch\application/index/view\public\sample_layer.html";i:1551065534;s:26:"template/login_dialog.html";i:1551083825;s:23:"template/login_tpl.html";i:1551083825;s:33:"template/forget_password_tpl.html";i:1551083825;s:25:"template/footer_menu.html";i:1551083825;}*/ ?>
<!DOCTYPE html>
...
<article class="f24">
		...
		<div class="swiper-container swiper-container-horizontal swiper-container-ios">
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide swiper-slide-active">
					<video  src="http://mch.new.com/uploads/<?php echo htmlentities($info['goods_video']); ?>" autoplay="autoplay"></video>
				</div>
				...
				<div class="swiper-slide swiper-slide-active">
					<img src="http://mch.new.com/static/common/img/banner/cy_top_banner.jpg" alt="" class="common_default_img">
				</div>
	...
	<section class="content-padding content_main wy_list" style="background:#F9CD33;">
		<div class="">
			<div class="columns_flex l-r-sides count_down_module">
				<div class="mid_module_left">
					<img src="http://mch.new.com/static/common/img/wy_dz.png" alt="">
					<div>
		...
		<div class="apply_item">
			...
			<a href="">
				<img src="http://mch.new.com/static/common/img/apply.jpg" alt="">
			</a>
		</div>
		<div class="apply_item">
			<span class="content-label">中心店加盟方案</span>
			<a href="">
				<img src="http://mch.new.com/static/common/img/apply1.jpg" alt="">
			</a>
			<a href="">
				<img src="http://mch.new.com/static/common/img/apply2.jpg" alt="">
			</a>
		</div>
		<div class="apply_item">
			<span class="content-label">工作室加盟方案</span>
			<a href="">
				<img src="http://mch.new.com/static/common/img/apply3.jpg" alt="">
			</a>
			<a href="">
				<img src="http://mch.new.com/static/common/img/apply4.jpg" alt="">
			</a>
		</div>
	</section>
</article>
    ...
    <form method="post" class="bg-fff brand_form">
        ...
        <div class="upload-picture-module f24">
			<div>
				<div class="picture-module">
					<!--<input type="file" class="uploadImg uploadSingleImg">-->
					<img class="upload_img" src="http://mch.new.com/static/common/img/brand_template_img.jpg" alt="">
					<!--<input type="hidden" name="authorization" class="img" data-src="" value=""/>-->
				</div>
			</div>
            <div class="brand_txt example">
                <p>如非自有商标需所有权者授权</p>
                <a href="http://mch.new.com/static/common/img/brand_template_img.jpg" download="brand_template_img.jpg" class="template_btn pink">商品授权书样板></a>
            </div>
		</div>
    </form>
</section>
...
<script type="text/javascript" src="http://mch.new.com/static/common/js/uploadImgToTemp.js"></script>
<script type="text/javascript">
    //设置品牌弹窗
