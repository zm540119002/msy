<?php /*a:3:{s:78:"/home/www/web/thinkphp5.1/mch/application/index_admin/view/project/manage.html";i:1551064593;s:27:"template/admin_pc/base.html";i:1551077175;s:90:"/home/www/web/thinkphp5.1/mch/application/index_admin/view/goods_category/linkage_tpl.html";i:1551064593;}*/ ?>
<!DOCTYPE HTML>
<html><head>
...
<div style="display:none">
    ...
    <div style="display:none">
        <div id="loading">
            <div class='loading'><img src='http://mch.meishangyun.com/static/index_admin/img/default/loading.gif' alt='loading'></div>
        </div>
    </div>
...
<!--自定义js-->
    ...
    <script type="text/javascript" src="http://mch.meishangyun.com/static/index_admin/js/categoryLinkage.js"></script>
    <script type="text/javascript">
        $(function () {
            ...
            $('body').on('click','.addProjectGoods',function(){
                var _thisTr = $(this).parents('tr');
                var url =  controller + 'addProjectGoods/id/' + _thisTr.data('id');
                location.href = url;
            });
        });
    </script>
