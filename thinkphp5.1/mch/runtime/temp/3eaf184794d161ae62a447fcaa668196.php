<?php /*a:2:{s:75:"/home/www/web/thinkphp5.1/mch/application/index_admin/view/user/manage.html";i:1551064593;s:27:"template/admin_pc/base.html";i:1551077175;}*/ ?>
<!DOCTYPE HTML>
<html><head>
    ...
    <div class="page">
        <div class="fixed-bar">
            <div class="item-title">
                <ul class="tab-base">
                    <li><a href="<?php echo url('User/manage'); ?>" class="current"><span>管理</span></a></li>
                    <li><a href="<?php echo url('User/edit'); ?>"><span>编辑</span></a></li>
                </ul>
            </div>
        </div>
