...
return [
    'menu' => [
        ...
        'brand'=>[
            ...
            'sub_menu' => [
                ['id'=>301,'name'=>'产商品牌审核','display'=>1,'controller'=>'Brand','action'=>'auditManage',],
            ],
        ],
        'store'=>[
            'id'=>400,'name'=>'店铺审核','type'=>2,
            'sub_menu' => [
                ['id'=>401,'name'=>'产商店铺审核','display'=>1,'controller'=>'Store','action'=>'auditManage',],
            ],
        ],
        'goods'=>[
            'id'=>400,'name'=>'商品审核','type'=>2,
            'sub_menu' => [
                ['id'=>401,'name'=>'产商店铺商品审核','display'=>1,'controller'=>'Goods','action'=>'auditManage',],
            ],
        ],
