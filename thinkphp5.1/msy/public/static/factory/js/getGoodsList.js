...
function disableBtn(){
    var listUl = $('#list');
    listUl.find('li').find('.move-btn').removeAttr('disabled');
    listUl.find('li:first').find('.up-btn').attr('disabled','disabled');
    listUl.find('li:last').find('.down-btn').attr('disabled','disabled');
}