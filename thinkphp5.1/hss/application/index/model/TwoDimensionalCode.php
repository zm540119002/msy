...
class TwoDimensionalCode extends \common\model\Base {
    ...
    public function compose($user)
    {
        ...
        imagettftext($im, 25, 0, 200, 99, $text_color, $init['font'], $init['name']); //名字
        ...
        imagecopyresized($im, $hss_3['obj'], 0, 1180, 0, 0, 538, 320, $hss_3['width'],$hss_3['height'] );  //平台logo
        imagecopyresized($im, $qrcode['obj'], 580, 1220, 0, 0, 160, 160, $qrcode['width'], $qrcode['width'] );  //二维
