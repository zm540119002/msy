...
class TwoDimensionalCode extends \common\model\Base {
    ...
    public function compose($user)
    {
        ...
        imagecopyresized($im, $hss_3['obj'], 0, 1000, 0, 0, 563, 309, $hss_3['width'],$hss_3['height'] );  //平台logo
        imagecopyresized($im, $qrcode['obj'], 550, 1000, 0, 0, 200, 200, $qrcode['width'], $qrcode['width'] );  //二维
