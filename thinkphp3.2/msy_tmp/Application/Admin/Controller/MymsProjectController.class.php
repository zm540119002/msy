...
class MymsProjectController extends BaseController {
    //项目管理
    public function projectManage(){
        if(IS_POST){
        }else{
            //所有项目分类
            $this->allCategoryList = D('MymsProjectCategory')->selectProjectCategory();
            $this->display();
        }
    }
    ...
    public function projectEdit(){
        ...
        if(IS_POST){
            ...
            $this->allCategoryList = D('MymsProjectCategory')->selectProjectCategory();
            //所有商品分类
            $this->allGoodsCategoryList = D('MymsGoodCategory')->selectGoodsCategory();
            //要修改的项目
