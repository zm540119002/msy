...
class MymsGoodsController extends BaseController {
    //商品管理
    public function goodsManage(){
        if(IS_POST){
        }else{
            //所有商品分类
            $this->allCategoryList = D('MymsGoodCategory')->selectGoodsCategory();
            $this->display();
        }
    }
    ...
    public function goodsProjectList(){
        if(IS_POST){
            if(isset($_POST['goodsId']) && $_POST['goodsId']){
                ...
                $where['id']  = $goodsId;
                $addGoodsList = D('MymsGoods')->selectGoods($where);
            ...
            if(isset($_POST['projectId']) && $_POST['projectId']){
                ...
                $addGoodsList = D('MymsProject')->selectProjectGoods($where,$field,$join);
                $this->addGoodsList = $addGoodsList;
            }
            $this->display();
        }
