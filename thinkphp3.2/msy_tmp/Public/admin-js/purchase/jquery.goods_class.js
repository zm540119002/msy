				...
				success: function(data){
					...
					if(data){
						for(var i = 0; i < data.length; i++){
							var tmp_vertline = "<img class='preimg' src='/public/images/purchase/default/vertline.gif'/>";
							...
							if(data[i].have_child == 1){
								src += " <img fieldid='"+data[i].id+"' status='open' nc_type='flex' src='/public/images/purchase/default/tv-expandable.gif' />";
							}else{
								src += " <img fieldid='"+data[i].id+"' status='none' nc_type='flex' src='/public/images/purchase/default/tv-item.gif' />";
							}
							...
							if(data[i].have_child == 1){
								src += " <img fieldid='"+data[i].id+"' status='open' nc_type='flex' src='/public/images/purchase/default/tv-item1.gif' />";
							}else{
								src += " <img fieldid='"+data[i].id+"' status='none' nc_type='flex' src='/public/images/purchase/default/tv-expandable1.gif' />";
							}
