...
class GoodsBaseModel extends Model {
    ...
    public function selectGoodsBase($where=[],$field=[],$join=[]){
        ...
        $_field = array(
            ...
            'gb.sort','gb.price', 'gb.inventory','gb.main_img','gb.detail_img','gb.create_time','gb.intro','gb.notices','gb.tag'
        ,   'gb.package_num','gb.package_unit','gb.purchase_unit','gb.single_specification','gb.thumb_img','gb.notices',
