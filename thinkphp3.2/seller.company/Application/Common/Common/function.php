...
require_once(APP_PATH . '/Common/Common/page.php');
require_once(APP_PATH . '/Common/Common/seller_function.php');
require_once(APP_PATH . '/Common/Common/myms_function.php');
 ...
 */
function wxPay($goods,$order_sn,$total_fee,$notify_url,$attach){
    require_once APP_PATH."Component/WxpayAPI/lib/WxPay.Api.php";
    require_once APP_PATH."Component/WxpayAPI/WxPay.JsApiPay.php";
    require_once APP_PATH.'Component/WxpayAPI/log.php';
