...
// 密码加密证书（这条一般用不到的请随便配）
const SDK_ENCRYPT_CERT_PATH = '/yjdata/www/www/web/thinkphp3.2/msy/Application/Component/payment/unionpay/acp_prod_enc.cer';
...
//文件下载目录 
const SDK_FILE_DOWN_PATH = APP_PATH.'/Component/payment/unionpay/file/';

//日志 目录 
const SDK_LOG_FILE_PATH =APP_PATH.'/Component/payment/unionpay/logs/';
