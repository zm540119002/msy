...
return array(
    ...
    'WX_CONFIG' => array(
        ...
        //TODO:公众号支付回调函数
        'CALL_BACK_URL_ORDER'  => "http://".$_SERVER['HTTP_HOST']."/index.php/Purchase/CallBack/notifyUrl/pay_code/weixin.order.",
        'CALL_BACK_URL_RECHARGE'  => "http://".$_SERVER['HTTP_HOST']."/index.php/Purchase/CallBack/notifyUrl/pay_code/weixin.recharge",
        /**
