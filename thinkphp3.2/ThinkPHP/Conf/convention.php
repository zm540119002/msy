...
return  array(
    ...
    /* Cookie设置 */
    'COOKIE_EXPIRE'         =>  24 * 60 * 60,       // Cookie有效期
    ...
    'TMPL_PARSE_STRING' => array(
        'PUBLIC_IMG' => __ROOT__ .'/Public/img',                //公共-前台-img目录
        'PUBLIC_JS' => __ROOT__ .'/Public/js',                  //公共-前台-js目录
        'PUBLIC_CSS' => __ROOT__ .'/Public/css',                //公共-前台-css目录
        'PUBLIC_ADMIN_IMG' => __ROOT__ .'/Public/admin-img',    //公共-后台-img目录
        'PUBLIC_ADMIN_JS' => __ROOT__ .'/Public/admin-js',      //公共-后台-js目录
        'PUBLIC_ADMIN_CSS' => __ROOT__ .'/Public/admin-css',    //公共-后台-css目录
        'UPLOADS_IMG' => __ROOT__ .'/Uploads',                  //Uploads目录
    ),
    //注册根命名空间
