 ...
 * 
 * @author molong
 * @time 2013年12月14日 10:25:46
 * @url http://www.tensent.cn
 * @email molong@tensent.cn
 *
 */
namespace Vendor\Qrcode;
class Qrcode {
	...
	* Return block number 1
	 ...
	 * @param $eclevel string <ul><li>
     * L : About 7% or less errors can be corrected.</li><li>
     * M : About 15% or less errors can be corrected.</li><li>
     * Q : About 25% or less errors can be corrected.</li><li>
     * H : About 30% or less errors can be corrected.</li></ul>
	 * @param $pixelPerPoint int 像素
	 ...
	 * 
	 */
	public function png($str = '', $filename = false, $eclevel = "H", $pixelPerPoint = 8, $outerFrame = 2, $saveandprint = false)
	{
