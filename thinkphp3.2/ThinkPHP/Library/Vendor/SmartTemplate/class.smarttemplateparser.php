<?php
	...
	*/
	class SmartTemplateParser
	{
		...
		* {payment}               :  array( "_obj",                   "payment" )  ->  $_obj['payment']
		* {payment.value}         :  array( "_obj['payment']",        "value" )    ->  $_obj['payment']['value']
		* {payment.0.value}       :  array( "_obj['payment'][0]",     "value" )    ->  $_obj['payment'][0]['value']
		* {top.payment}           :  array( "_stack[0]",              "payment" )  ->  $_stack[0]['payment']
		* {parent.payment}        :  array( "_stack[$_stack_cnt-1]",  "payment" )  ->  $_stack[$_stack_cnt-1]['payment']
		* {parent.parent.payment} :  array( "_stack[$_stack_cnt-2]",  "payment" )  ->  $_stack[$_stack_cnt-2]['payment']
		*
