...
class ProjectController extends BaseController {
    ...
    public function projectIndex(){
        if(IS_POST){
            ...
            $where['parent_id_1'] = 0;
            $pCatList = D('ProjectCategory')->selectProjectCategory($where);
    ...
    public function projectInfo(){
        ...
        $dataArray[] = date("m月d日",strtotime('1 day'))."星期".$weekArray[date("w",strtotime('1 day'))];  //前一天
        $dataArray[] = date("m月d日",strtotime('2 day'))."星期".$weekArray[date("w",strtotime('2 day'))];  //前一天
        $dataArray[] = date("m月d日",strtotime('3 day'))."星期".$weekArray[date("w",strtotime('3 day'))];  //前一天
...
//        }
    ...
    public function projectList(){
        ...
        if($position === 'index' && $page == 1){
            $where['parent_id_1'] = 0;
            $pCategoryList = D('ProjectCategory')->selectProjectCategory($where);
            $catProjectList = [];
